					...
					<div class="agile_ecommerce_tab_left">
						...
						<div class="simpleCart_shelfItem" style="margin-top: -10px;">
							...
							<form action="#" method="post">
								...
								<div class="col-md-1"></div> 
								<div class="col-md-6">
									<a class="beta-btn primary" href="{{ url('product', $product->id) }}" style="display: block; border: blue solid 1px;height: 35px;line-height: 35px;border-radius: 5px;"><span ><i class="fa fa-chevron-right" ></i>Chi tiết</span></a>
								</div>
